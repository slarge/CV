...
tribble(
  ~Start, ~End, ~Position,
  2011, 2014, "\\textbf{Post doctoral Researcher}, Integrated Statistics, Inc \\& Northeast Fisheries Science Center",
...
tribble(
  ~Start, ~End, ~Position,
  2017, 2017, "\\textbf{Stock Assessment Consultant}, \\textit{United Nations Food and Agriculture Organization (FAO)}",
...
```{r research-papers}
 bibliography_entries("large_pubs.bib") %>%
   dplyr::filter(tolower(type) == "article-journal") %>%
   dplyr::arrange(issued, author)
...
# Presentations
## Invited talks
 * Workshop leader, *Delineating the Issues of Climate Change and Impacts to Marine Ecosystems: Bridging the Gap Between Research, Assessment, Policy and Management* IMBER--ClimEco4, Shanghai, June 2017.
